...
class Coastalynk_Maps_Settings {
    ...
    public function save_settings() {
        ...
        if( $current_tab === 'general' ) {
            ...
            $coatalynk_levy_calculator_type = isset( $_POST['coatalynk_levy_calculator_type'] ) ? sanitize_textarea_field( stripslashes_deep( $_POST['coatalynk_levy_calculator_type'] ) ) : 'normal';

            update_option( 'coatalynk_levy_calculator_type',                $coatalynk_levy_calculator_type );
