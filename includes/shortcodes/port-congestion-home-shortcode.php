...
/**
 * Class Coastalynk_Dashboard_Port_Congestion_Home_Shortcode
 */
class Coastalynk_Dashboard_Port_Congestion_Home_Shortcode {
    ...
    public static function instance() {
        ...
        if ( is_null( self::$instance ) && ! ( self::$instance instanceof Coastalynk_Dashboard_Port_Congestion_Home_Shortcode ) ) {
    ...
    /**
     * Coastalynk_Dashboard_Port_Congestion_Home_Shortcode hooks
     */
    private function hooks() {
        add_shortcode( 'Home-Page-Congestion', [ $this, 'shortcode_body' ] );
    ...
    */
    function coastalynk_enqueue_scripts() : void {
        ...
        wp_enqueue_script( 'leaflet-screenshoter', 'https://unpkg.com/leaflet-simple-map-screenshoter', array( 'jquery' ) );
 ...
 * Class instance.
 */
Coastalynk_Dashboard_Port_Congestion_Home_Shortcode::instance();