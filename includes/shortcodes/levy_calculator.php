...
class Coastalynk_Levy_Calculator_Shortcode {
    ...
    public function shortcode_body( $atts ) {
        ...
        wp_enqueue_style( 'coastalynk-levy-calculator-shortcode-style' );
        wp_enqueue_script( 'coastalynk-levy-calculator-shortcode-script' );
        ...
        $coatalynk_levy_calculator_type_placeholder 	    = __( "Enter NT value", "castalynkmap" );
        $coatalynk_levy_calculator_type_desc 	            = __( "Please enter a valid NT value", "castalynkmap" );
        if( $coatalynk_levy_calculator_type == 'dwt' ) {
            $coatalynk_levy_calculator_type_placeholder 	    = __( "Enter DWT value", "castalynkmap" );
            $coatalynk_levy_calculator_type_desc 	            = __( "Please enter a valid DWT value", "castalynkmap" );
        }
        ob_start();
            ...
            <div class="vessel-dashboard-container">
                ...
                <div class="datalastic-container">
                    ...
                    <div class="coastalynk-calculator-container">
                        ...
                        <p class="coastalynk-calculator-subtitle"><?php _e( "Enter values to calculate the levy amount", "castalynkmap" );?></p>
                        <form id="coastalynk-download-levy-receipt" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" name="coastalynk-download-levy-receipt">
                            <div class="coastalynk-calculator-form-group">
                                <label for="coastalynk-calculator-gt"><?php _e( "Gross Tonnage (GT)", "castalynkmap" );?></label>
                                <input type="number" name="coastalynk_calculator_gt" id="coastalynk-calculator-gt" placeholder="<?php _e( "Enter GT value", "castalynkmap" );?>" min="0" step="0.01">
                            ...
                            <div class="coastalynk-calculator-form-group">
                                <?php if( $coatalynk_levy_calculator_type == 'dwt' ) { ?>
                                    <label for="coastalynk-calculator-nt"><?php _e( "Dead Weight Tonnage (DWT)", "castalynkmap" );?></label>
                                <?php } else { ?>
                                    <label for="coastalynk-calculator-nt"><?php _e( "Net Tonnage (NT)", "castalynkmap" );?></label>
                                <?php } ?>
                                <input type="number" name="coastalynk_calculator_nt" id="coastalynk-calculator-nt" placeholder="<?php echo $coatalynk_levy_calculator_type_placeholder;?>" min="0" step="0.01">
                                <div class="coastalynk-calculator-error-message" id="coastalynk-calculator-nt-error"><?php echo $coatalynk_levy_calculator_type_desc;?></div>
                            </div>
                            ...
                            <button class="coastalynk-calculator-calculate-btn" type="button" id="coastalynk-calculator-calculate"><?php _e( "Calculate Levy", "castalynkmap" );?></button>
                            <button class="coastalynk-calculator-Download-Receipt-btn" type="button" id="coastalynk-calculator-Download-Receipt-btn"><?php _e( "Download Receipt", "castalynkmap" );?></button>
                            <button class="coastalynk-calculator-reset-btn" type="button" id="coastalynk-calculator-reset-btn"><?php _e( "Reset", "castalynkmap" );?></button>
                            ...
                            <?php wp_nonce_field('coastalynk_leavy_form_download_pdf_submit_form', 'coastalynk_leavy_form_download_pdf_submit_nonce'); ?>
                            <input type="hidden" name="action" value="coastalynk_leavy_form_download_pdf_submit" />
                        </form>
                    </div>
                </div>
            </div>
    ...
    */
    function coastalynk_enqueue_scripts() : void {
        ...
        // Enqueue my styles.
        wp_register_style( 'coastalynk-levy-calculator-shortcode-style', CSM_CSS_URL.'frontend/levy-calculator-shortcode.css?'.time() );

        // Enqueue my scripts.
        wp_register_script( 'coastalynk-levy-calculator-shortcode-script', CSM_JS_URL.'frontend/levy-calculator-shortcode.js', array("jquery"), time(), true ); 
        ...
        wp_localize_script( 'coastalynk-levy-calculator-shortcode-script', 'COSTALYNK_CALC_VARS', [          
                ...
                'calculator_type'   => $coatalynk_levy_calculator_type,
